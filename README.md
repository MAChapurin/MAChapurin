...
В проектах стараюсь писать читаемый код и использовать современные подходы.
...
### CSS-фреймворки и UI-библиотеки
...
- https://smp3d.ru/ — коммерческий сайт мастерской 3D-печати  
- https://4ad-royalty.vercel.app/ — лендинг  
- https://github.com/MAChapurin/quiz-builder — конструктор квизов  
- https://github.com/MAChapurin/shope — тренировочный интернет-магазин  
- https://github.com/MAChapurin/preax-weather-app — приложение прогноза погоды  
- https://github.com/MAChapurin/career-app — учебный проект (клон HH)  
...
Telegram: https://t.me/MAChapurin  
Email: machapurin@icloud.com
